...
class ScraperRedesRiopaila:
    ...
    def scrapear_instagram(self):
        ...
        for i, post_url in enumerate(posts[:100]):
    ...
    def guardar(self):
        ...
        with open("C:\\Users\\mrplu\\Downloads\\base_redes_riopaila.txt", "w", encoding="utf-8") as f:
        ...
        print("✅ Archivo generado: base_redes_riopaila.txt")
