...
# ── API / canales (Módulo 3) ──────────────────────────────────────────────────
API_HOST: str = _optional("API_HOST", "0.0.0.0")
API_PORT: int = int(_optional("API_PORT", "8000"))
CHAT_CHANNEL: str = _optional("CHAT_CHANNEL", "api")

# ── WhatsApp Cloud API (Meta) — webhook opcional en FastAPI ───────────────────
WHATSAPP_VERIFY_TOKEN: str = _optional("WHATSAPP_VERIFY_TOKEN")
WHATSAPP_ACCESS_TOKEN: str = _optional("WHATSAPP_ACCESS_TOKEN")
WHATSAPP_PHONE_NUMBER_ID: str = _optional("WHATSAPP_PHONE_NUMBER_ID")
WHATSAPP_API_VERSION: str = _optional("WHATSAPP_API_VERSION", "v21.0")
# Número visible en la web Streamlit (enlace wa.me, sin + ni espacios)
WHATSAPP_DEMO_NUMBER: str = _optional("WHATSAPP_DEMO_NUMBER", "15550598036")
WHATSAPP_DEMO_DISPLAY: str = _optional("WHATSAPP_DEMO_DISPLAY", "+1 (555) 059-8036")
# Bot de Telegram (opcional): https://t.me/nombre_del_bot
TELEGRAM_BOT_URL: str = _optional("TELEGRAM_BOT_URL")
TELEGRAM_BOT_DISPLAY: str = _optional("TELEGRAM_BOT_DISPLAY", "Riopaila Agente")
